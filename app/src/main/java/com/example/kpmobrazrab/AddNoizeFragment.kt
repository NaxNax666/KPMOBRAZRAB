...
class AddNoizeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.srcImageAWN.setImageBitmap(Storage.bitmap)
        ...
        binding.executeButtonAWN.setOnClickListener {
            ...
            (binding.srcImageAWN.drawable as? BitmapDrawable?)?.let {
                binding.destImageAWN.setImageBitmap(CoreSystem.AddWhiteNoise(it.bitmap, middle, strength))
            }
        }
    }
}